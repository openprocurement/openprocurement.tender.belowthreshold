...
from openprocurement.tender.belowthreshold.validation import (
    ...
    validate_cancel_award_of_merged_contracts
)
...
class TenderAwardResource(APIResource):
    ...
    @json_view(content_type="application/json", permission='edit_tender', validators=(validate_patch_award_data, validate_update_award_in_not_allowed_status, validate_update_award_only_for_active_lots, validate_cancel_award_of_merged_contracts))
    def patch(self):
        """Update of award
